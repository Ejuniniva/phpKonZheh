  ...
  <div class="container header__container">
    ...
    <nav class="header__nav">
      <ul class="menu header__menu">
        <li><a href="products.php" class="text-link menu__item ">Продукция</a></li>
        <li><a href="aboutUs.php" class="text-link menu__item">О нас</a></li>
        <li><a href="stocks.php" class="text-link menu__item">Новости</a></li>
        ...
        <?php if (isset($_SESSION['user'])) {
          ?><li><a href="personalAccount.php" class="text-link menu__item">Личный кабинет</a></li>
